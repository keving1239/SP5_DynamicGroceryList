...
import {Text,StyleSheet, View, TouchableOpacity,KeyboardAvoidingView, TextInput, ScrollView, Keyboard, Alert, Password} from 'react-native';
                        ...
                        onPress: async () =>{
                                ...
                                if(db_note_call[0] == null){
                                    ...
                                    for(var x =0; x < note_array.length; x++){
                                        temp_array[x] = [note_array[x], note_id_array[x]];
                                      }
                                ...
                                if(db_share[0] == null){
                                    ...
                                    for(var x =0; x < note_array2.length; x++){
                                        temp_array2[x] = [note_array2[x], note_id_array2[x]];
                                      }
